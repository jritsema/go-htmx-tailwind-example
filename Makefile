...
apprunner: image
	cd iac; \
	terraform init; \
	terraform apply -var="app=${name}" -var="repository_url=$(shell cat ecr-repo)" -auto-approve

## destroy: tear down infrastructure
.PHONY: destroy
destroy:
	cd iac; \
	terraform destroy -var="app=${name}" -var="repository_url=$(shell cat ecr-repo)" -auto-approve; \
